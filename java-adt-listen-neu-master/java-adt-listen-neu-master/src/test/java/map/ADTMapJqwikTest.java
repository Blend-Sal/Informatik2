...
public abstract class ADTMapJqwikTest {
    ...
    */
    ...
    boolean isEmpty_insert(@ForAll("maps") Map<K, V> m,
                           @ForAll("keys") K k,
                           @ForAll("values") V v) {
        return !this.<K, V>empty().insert(k, v).isEmpty();
    }
    ...
    boolean member_empty(@ForAll("keys") K k) {
        return !this.<K, K>empty().member(k);
    }
    ...
    boolean insert_insert(@ForAll("maps") Map<K, V> m,
                          ...
                          @ForAll("values") V v1,
                          @ForAll("values") V v2) {
        return m.insert(k1, v1).insert(k2, v2).equals(k1.equals(k2) ? m.insert(k2, v2) : m.insert(k2, v2).insert(k1, v1));
    ...
    boolean get_insert(@ForAll("maps") Map<K, V> m,
                       ...
                       @ForAll("keys") K k2,
                       @ForAll("values") V v) {
        return Objects.equals(m.insert(k1, v).get(k2), (k1.equals(k2) ? v : m.get(k2))); //null-sicher vergleichen!
    }
    ...
    boolean get_delete(@ForAll("maps") Map<K, V> m,
                       @ForAll("keys") K k1,
                       @ForAll("keys") K k2) {
        return Objects.equals(m.delete(k1).get(k2), k1.equals(k2) ? null : m.get(k2)); //null-sicher vergleichen!
    }
    ...
    boolean defOfUnionGet(@ForAll("maps") Map<K, V> a,
                          @ForAll("maps") Map<K, V> b,
                          @ForAll("keys") K k) {
        return Objects.equals(a.union(b).get(k), a.member(k) && b.member(k) || a.member(k) ? a.get(k) : b.member(k) ? b.get(k) : null); //null-sicher vergleichen!
    }
